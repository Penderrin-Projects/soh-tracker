local entrance_value_table = {
    ...
    [0x0340] = "OGC Great Fairy Fountain -> Castle Grounds", --- duplicate
    ...
    [0x05BC] = {
        ...
        [0xEB] = {
            [0x54] = "Zora River -> ZR Storms Grotto"
        },
        [0xEE] = {
            [0x56] = "Sacred Forest Meadow -> SFM Storms Grotto"
        },
        [0xF0] = {
            [0x5A] = "GV Fortress Side -> GV Storms Grotto"
        }
    },
    [0x05A4] = {
        [0xEF] = {
            [0x57] = "Lake Hylia -> LH Grotto"
        },
        [0xF9] = {
            [0x61] = "DMC Lower Nearby -> DMC Hammer Grotto"
        },
        [0xFB] = {
            [0x62] = "GC Grotto Platform -> GC Grotto"
        },
        [0xFC] = {
            [0x63] = "Lon Lon Ranch -> LLR Grotto"
        }
    },
    [0x036D] = {
        [0xE6] = {
            [0x54] = "Zora River -> ZR Fairy Grotto"
        },
        [0xFF] = {
            [0x51] = "Hyrule Field -> HF Fairy Grotto"
        },
        [0xFF] = {
            [0x56] = "Sacred Forest Meadow -> SFM Fairy Grotto"
        },
        [0xFF] = {
            [0x58] = "Zoras Domain -> ZD Storms Grotto"
        },
        [0xFF] = {
            [0x5D] = "GF Entrances Behind Crates -> GF Storms Grotto"
        }
    },
    [0x003F] = {
        [0x29] = {
            [0x54] = "Zora River -> ZR Open Grotto"
        },
        [0x7A] = {
            [0x61] = "DMC Upper Nearby -> DMC Upper Grotto"
        },
        [0x57] = {
            [0x60] = "Death Mountain -> DMT Storms Grotto"
        },
        [0x28] = {
            [0x52] = "Kak Backyard -> Kak Open Grotto"
        },
        [0x00] = {
            [0x51] = "Hyrule Field -> HF Near Market Grotto"
        },
        [0x03] = {
            [0x51] = "Hyrule Field -> HF Open Grotto"
        },
        [0x22] = {
            [0x51] = "Hyrule Field -> HF Southeast Grotto"
        },
        [0x14] = {
            [0x5B] = "Lost Woods -> LW Near Shortcuts Grotto"
        },
        [0x2C] = {
            [0x55] = "Kokiri Forest -> KF Storms Grotto"
        }
    },
    [0x05FC] = {
        [0xF8] = {
            [0x60] = "Death Mountain Summit -> DMT Cow Grotto"
        }
    },
    [0x05A0] = {
        [0xE7] = {
            [0x52] = "Kakariko Village -> Kak Redead Grotto"
        }
    },
    [0x05B8] = {
        [0xF6] = {
            [0x5F] = "Hyrule Castle Grounds -> HC Storms Grotto"
        }
    },
    [0x05C0] = {
        [0xE1] = {
            [0x51] = "Hyrule Field -> HF Tektite Grotto"
        }
    },
    [0x0598] = {
        [0xE5] = {
            [0x51] = "Hyrule Field -> HF Near Kak Grotto"
        }
    },
    [0x05A8] = {
        [0xE4] = {
            [0x51] = "Hyrule Field -> HF Cow Grotto"
        }
    },
    [0x059C] = {
        [0xE6] = {
            [0x51] = "Hyrule Field -> HF Inside Fence Grotto"
        }
    },
    [0x05B4] = {
        [0xED] = {
            [0x56] = "SFM Entryway -> SFM Wolfos Grotto"
        }
    },
    [0x05B0] = {
        [0xF5] = {
            [0x5B] = "LW Beyond Mido -> LW Scrubs Grotto"
        }
    },
    [0x05AC] = {
        [0xF2] = {
            [0x5A] = "GV Grotto Ledge -> GV Octorok Grotto"
        }
    },
    [0x05C4] = {
        [0xF3] = {
            [0x5B] = "LW Beyond Mido -> Deku Theater"
        }
    },
    --- Grave
    ...
    [0x05F4] = "Prelude of Light Warp -> Temple of Time", --- duplicate
    --- BlueWarp
