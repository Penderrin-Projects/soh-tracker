        ...
        if (shop_trans.has(i)) {
            ...
            if (item !== undefined) {
                ...
                if (i.startsWith("Market Bazaar") || i.startsWith("Castle Town Bazaar")) {
                    ...
                    if (player !== 0) {buffer[`shop.basar_child/${placement}.name`] = "Player " + player;} else {buffer[`shop.basar_child/${placement}.name`] = "";}
                }
                if (i.startsWith("Market Potion") || i.startsWith("Castle Town Potion")) {
                    ...
                    if (player !== 0) {buffer[`shop.magic_child/${placement}.name`] = "Player " + player;} else {buffer[`shop.magic_child/${placement}.name`] = "";}
                }
                if (i.startsWith("Market Bombchu") || i.startsWith("Bombchu")) {
                    ...
                    if (player !== 0) {buffer[`shop.bombchu/${placement}.name`] = "Player " + player;} else {buffer[`shop.bombchu/${placement}.name`] = "";}
                }
                if (i.startsWith("Kak Bazaar") || i.startsWith("Kakariko Bazaar")) {
                    ...
                    if (player !== 0) {buffer[`shop.basar_adult/${placement}.name`] = "Player " + player;} else {buffer[`shop.basar_adult/${placement}.name`] = "";}
                }
                if (i.startsWith("Kak Potion") || i.startsWith("Kakariko Potion")) {
                    ...
                    if (player !== 0) {buffer[`shop.magic_adult/${placement}.name`] = "Player " + player;} else {buffer[`shop.magic_adult/${placement}.name`] = "";}
                }
                if (i.startsWith("GC") || i.startsWith("Goron")) {
                    ...
                    if (player !== 0) {buffer[`shop.goron/${placement}.name`] = "Player " + player;} else {buffer[`shop.goron/${placement}.name`] = "";}
                }
                if (i.startsWith("ZD") || i.startsWith("Zora")) {
                    ...
                    if (player !== 0) {buffer[`shop.zora/${placement}.name`] = "Player " + player;} else {buffer[`shop.zora/${placement}.name`] = "";}
                }
                if (i.startsWith("KF") || i.startsWith("Kokiri")) {
                    ...
                    if (player !== 0) {buffer[`shop.kokiri/${placement}.name`] = "Player " + player;} else {buffer[`shop.kokiri/${placement}.name`] = "";}
                }
            }
        }
    }
