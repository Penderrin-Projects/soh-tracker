...
export default class CustomLogicUpdater {
    ...
    #augmentLogic(logic) {
        ...
        const customLogic = this.#getCustomLogicData();
    ...
    #updateLogic() {
        const logic = this.#getLogicData();
        if (useCustomLogicObserver.value) {
            const customLogic = this.#augmentLogic(logic);
